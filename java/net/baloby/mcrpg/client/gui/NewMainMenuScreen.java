...
@OnlyIn(Dist.CLIENT)
public class NewMainMenuScreen extends MainMenuScreen {
    ...
    public NewMainMenuScreen(boolean p_i51107_1_) {
    ...
    public static void open(){
        ...
        mc.submitAsync(() -> {mc.setScreen(new NewMainMenuScreen());});}
}
