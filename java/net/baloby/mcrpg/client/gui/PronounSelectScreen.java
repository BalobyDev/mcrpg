...
public class PronounSelectScreen extends Screen {
    ...
    protected void init() {
        Button pronouns = this.addButton(new Button(this.width/2-50,this.height/2-50,100,20,
                new StringTextComponent(this.selected.getSubjective()+"/"+this.selected.getObjective()+"/"+this.selected.getPosNoun()),
    ...
    private void setPronouns(){
        ...
        nbt.putString("pos_noun",this.selected.getPosNoun());
        nbt.putString("pos_adj",this.selected.getPosAdj());
        nbt.putString("contraction",this.selected.getContraction());
    ...
    private void selectNext(){
        ...
        this.pronouns.setMessage(new StringTextComponent(this.selected.getSubjective()+"/"+this.selected.getObjective()+"/"+this.selected.getPosNoun()));
    }
