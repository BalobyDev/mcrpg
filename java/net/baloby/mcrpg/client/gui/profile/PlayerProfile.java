...
public class PlayerProfile extends Profile {
    ...
    public PlayerProfile(ServerPlayerEntity player, String name, int hp, int maxHp, int mp, int maxMp, int str, int mag, int def, int spd, ResourceLocation skin, HashMap<Integer,MoveType> moves) {
        super(player,name, hp, maxHp, mp, maxMp,str,mag,def,spd, skin, moves);
    }
