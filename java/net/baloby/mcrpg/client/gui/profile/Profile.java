...
public abstract class Profile {
    ...
    public Profile(ServerPlayerEntity player, String name, int hp, int maxHp, int mp, int maxMp, ResourceLocation skin, HashMap<Integer,MoveType> moves){
        this.player = player;
        this.name = name;
        this.hp = hp;
        this.maxHp = maxHp;
    ...
    public static PlayerProfile fromPlayer(ServerPlayerEntity player){
        ...
        PlayerProfile prof = new PlayerProfile(player,player.getDisplayName().getString(), (int) player.getHealth(), playerProfile.getMaxHp(), playerProfile.getMp(),
                playerProfile.getMaxMp(),new ResourceLocation(mcrpg.MODID,"textures/entity/camryn.png"),playerProfile.moveList());
        return prof;
    }
