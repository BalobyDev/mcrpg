...
public class HomeStewItem extends Item{
    ...
    public ItemStack finishUsingItem(ItemStack stack, World world, LivingEntity entity){
        if (entity instanceof  ServerPlayerEntity && world instanceof ServerWorld){
            ...
            if (pos==null)pos = ((ServerWorld) world).getSharedSpawnPos();
    ...
    public ITextComponent getDescription(){
        return new StringTextComponent("One taste of this stew and you'll taken back home to your nice, warm bed");
    }
