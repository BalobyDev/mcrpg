...
public class SunRootPieces {
    ...
    public static void start(LocationStructure structure, TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random){
        ...
        structure.getPositions().put(Npcs.RANA.get(),new NpcOffset(new BlockPos(10,1,10),blockPos,rotation));
        structure.getPositions().put(Npcs.FELINA.get(),new NpcOffset(new BlockPos(10,12,10),blockPos,rotation));

        rotationOffSet = new BlockPos(25,-1,0).rotate(rotation);
        ...
        structure.getPositions().put(Npcs.ALEX.get(),new NpcOffset(new BlockPos(11,1,7),blockPos,rotation));
        structure.getPositions().put(Npcs.GUNTER.get(),new NpcOffset(new BlockPos(9,1,7),blockPos,rotation));

        rotationOffSet = new BlockPos(0,-1,random.nextInt(20)+30).rotate(rotation);
        blockPos = rotationOffSet.offset(x,pos.getY(),z);
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public Piece(TemplateManager templateManagerIn, ResourceLocation resourceLocationIn, BlockPos pos, Rotation rotationIn){
            ...
            BlockPos blockPos = SunRootPieces.OFFSET.get(resourceLocation);
