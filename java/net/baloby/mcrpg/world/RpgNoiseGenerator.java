...
public final class RpgNoiseGenerator extends ChunkGenerator {
    public static final Codec<RpgNoiseGenerator> CODEC = RecordCodecBuilder.create((p_236091_0_) -> {
        ...
        })).apply(p_236091_0_, p_236091_0_.stable(RpgNoiseGenerator::new));
    });
    ...
    public RpgNoiseGenerator(BiomeProvider p_i241975_1_, long p_i241975_2_, Supplier<DimensionSettings> p_i241975_4_) {
        this(p_i241975_1_, p_i241975_1_, p_i241975_2_, p_i241975_4_);
    }

    private RpgNoiseGenerator(BiomeProvider p_i241976_1_, BiomeProvider p_i241976_2_, long p_i241976_3_, Supplier<DimensionSettings> p_i241976_5_) {
    ...
    public ChunkGenerator withSeed(long p_230349_1_) {
        return new RpgNoiseGenerator(this.biomeSource.withSeed(p_230349_1_), p_230349_1_, this.settings);
    }
