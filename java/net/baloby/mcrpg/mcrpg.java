...
public class mcrpg
{
    ...
    public void commonSetup(final FMLCommonSetupEvent event) {
        DeferredWorkQueue.runLater(() -> {
            ...
            GlobalEntityTypeAttributes.put(ModEntities.INFERNO.get(), RanaEntity.setCustomAttributes().build());
            ...
            GlobalEntityTypeAttributes.put(ModEntities.HUMANOID_PIGLIN.get(), RanaEntity.setCustomAttributes().build());
