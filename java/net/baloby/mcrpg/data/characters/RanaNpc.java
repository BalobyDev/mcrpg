...
public class RanaNpc extends BattleNpc{
    ...
    public RanaNpc(){
        super(Npcs.RANA.get(),"Rana", new ResourceLocation(mcrpg.MODID, "textures/entity/rana.png"), ModEntities.HUMANOID_SLIM.get(), Items.IRON_SWORD,20,20, Moves.FLORA.get(),Moves.HEAL.get());
