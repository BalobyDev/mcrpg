...
public class Npcs {
    ...
    public static final RegistryObject<NpcType<ClaireNpc>> CLAIRE = Registration.NPC_TYPES.register("claire", () -> new NpcType<>(ClaireNpc::new));
    public static final RegistryObject<NpcType<DaniNpc>> DANI = Registration.NPC_TYPES.register("dani", () -> new NpcType<>(DaniNpc::new));
    ...
    public static final RegistryObject<NpcType<IdaNpc>> IDA = Registration.NPC_TYPES.register("ida", ()-> new NpcType<>(IdaNpc::new));
    public static final RegistryObject<NpcType<JeanNpc>> JEAN = Registration.NPC_TYPES.register("jean",()->new NpcType<>(JeanNpc::new));
    public static final RegistryObject<NpcType<MavenNpc>> MAVEN = Registration.NPC_TYPES.register("maven",()->new NpcType<>(MavenNpc::new));
