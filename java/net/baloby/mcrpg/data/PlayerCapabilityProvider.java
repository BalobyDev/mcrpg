...
public class PlayerCapabilityProvider implements ICapabilitySerializable<INBT> {
    ...
    public static Capability<IPlayerData> CHAR_CAP = null;

    private LazyOptional<IPlayerData> instance = LazyOptional.of(()->CHAR_CAP.getDefaultInstance());
    ...
    private IPlayerData getInstance(){
