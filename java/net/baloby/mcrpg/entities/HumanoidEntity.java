...
public class HumanoidEntity extends MobEntity {
    ...
    public HumanoidEntity(EntityType<? extends HumanoidEntity> p_i48553_1_, World world, Npc character){
        ...
        if(character.headItem!=null) {
            this.setItemSlot(EquipmentSlotType.HEAD, character.headItem);
        }
    }

    public void setArmor(EquipmentSlotType type, ItemStack itemStack){
        if(itemStack!=null)setItemSlot(type,itemStack);
    }
