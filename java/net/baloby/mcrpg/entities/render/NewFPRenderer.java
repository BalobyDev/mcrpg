...
public class NewFPRenderer {
    ...
    private static final ResourceLocation CAMRYN = new ResourceLocation(mcrpg.MODID,"textures/entity/camryn.png");
    private final Minecraft minecraft;
    private ItemStack mainHandItem = ItemStack.EMPTY;
    private ItemStack offHandItem = ItemStack.EMPTY;
    private float mainHandHeight = 1;
    ...
    public NewFPRenderer(Minecraft p_i1247_1_) {
    ...
    private void renderMapHand(MatrixStack p_228403_1_, IRenderTypeBuffer p_228403_2_, int p_228403_3_, HandSide p_228403_4_) {
        this.minecraft.getTextureManager().bind(CAMRYN);
    ...
    private void renderPlayerArm(MatrixStack p_228401_1_, IRenderTypeBuffer p_228401_2_, int p_228401_3_, float p_228401_4_, float p_228401_5_, HandSide p_228401_6_) {
        ...
        NewPlayerRenderer playerrenderer = new NewPlayerRenderer(Minecraft.getInstance().getEntityRenderDispatcher());
        if (flag) {
