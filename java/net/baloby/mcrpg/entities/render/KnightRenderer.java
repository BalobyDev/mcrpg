...
import net.baloby.mcrpg.entities.custom.enemies.KnightEntity;
...
public class KnightRenderer extends BipedRenderer<KnightEntity, HumanoidModel<KnightEntity>> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(mcrpg.MODID,"textures/entity/crimson_knight.png");

    public KnightRenderer(EntityRendererManager manager) {
        super(manager, new HumanoidModel<>(0,false), 1.0f);
    ...
    public void render(KnightEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_){
        this.setModelProperties(p_225623_1_);
        super.render(p_225623_1_, p_225623_2_, p_225623_3_, p_225623_4_, p_225623_5_, p_225623_6_);

    }

    private void setModelProperties(KnightEntity p_177137_1_) {
        HumanoidModel<KnightEntity> playermodel = this.getModel();
    ...
    private static BipedModel.ArmPose getArmPose(KnightEntity p_241741_0_, Hand p_241741_1_) {
