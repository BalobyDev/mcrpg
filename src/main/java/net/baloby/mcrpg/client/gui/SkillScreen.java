...
public class SkillScreen extends Screen {
    ...
    private void createButton(int num){
        ...
        String txt = num >= moveSet.size() ?  "-" : moveSet.get(num).name+"   MP: "+(int)moveSet.get(num).cost;
        ...
        Button skillButton = addButton(new Button(i+5,j,80,20,new StringTextComponent(txt), button-> {
            finalRunnable.run();}));
